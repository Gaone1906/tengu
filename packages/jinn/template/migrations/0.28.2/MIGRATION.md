# Instance migration bundle: 0.28.1 → 0.28.2

<!-- BEGIN RELEASE RATIONALE -->
Jinn 0.28.2 changed no user-owned instance-template files. This empty bundle keeps patch upgrades aligned with the strict migration chain.
